      ...
      <div className="row mt-4">
        <div className="col-lg-4 col-md-6 mb-3">
          <div className={styles.imageContainer}>
            <img src="/images/Riders.jpg" alt="Image 1" className={styles.image} />
        ...
        <div className="col-lg-4 col-md-6 mb-3">
          <div className={styles.imageContainer}>
            <img src="/images/riders-photos (4).jpg" alt="Image 1" className={styles.image} />
            <div className={styles.overlayText}>
        ...
        <div className="col-lg-4 col-md-6 mb-3">
          <div className={styles.imageContainer}>
            <img src="/images/riders-photos (6).jpg" alt="Image 1" className={styles.image} />
            <div className={styles.overlayText}>
        ...
        <div className="col-lg-4 col-md-6 mb-3">
          <div className={styles.imageContainer}>
            <img src="/images/riders-photos (5).jpg" alt="Image 1" className={styles.image} />
            <div className={styles.overlayText}>
        ...
        <div className="col-lg-4 col-md-6 mb-3">
          <div className={styles.imageContainer}>
            <img src="/images/riders-photos (3).jpg" alt="Image 1" className={styles.image} />
            <div className={styles.overlayText}>
        ...
        <div className="col-lg-4 col-md-6 mb-3">
          <div className={styles.imageContainer}>
            <img src="/images/riders-photos (7).jpg" alt="Image 1" className={styles.image} />
            <div className={styles.overlayText}>
